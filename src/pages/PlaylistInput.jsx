    ...
    return (
      <div className="flex flex-col h-screen bg-gradient-to-b from-spotify-black to-gray-900 overflow-hidden">
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="bg-spotify-black bg-opacity-40 p-6 rounded-lg border border-gray-700 w-full max-w-md">
            <h1 className="text-2xl font-bold mb-4 text-center">Configuración necesaria</h1>
    ...
    <div className="flex flex-col h-screen bg-gradient-to-b from-spotify-black to-gray-900 overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <h1 className="text-3xl font-bold mb-6 text-center">Selecciona una playlist</h1>
          ...
          <div className="bg-spotify-black bg-opacity-40 p-6 rounded-lg border border-gray-700">
